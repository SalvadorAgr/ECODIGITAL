...
const DESCRIPTION = `There can be more than Notion and Miro. Ecodigital is a next-gen knowledge base that brings planning, sorting and creating all together.`;
