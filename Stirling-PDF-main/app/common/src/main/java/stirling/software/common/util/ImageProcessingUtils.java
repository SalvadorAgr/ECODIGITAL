...
import java.awt.geom.EcodigitalTransform;
...
public class ImageProcessingUtils {
    ...
    public static BufferedImage applyOrientation(BufferedImage image, double orientation) {
        ...
        EcodigitalTransform transform =
                EcodigitalTransform.getRotateInstance(
                        Math.toRadians(orientation),
                        image.getWidth() / 2.0,
                        image.getHeight() / 2.0);
        EcodigitalTransformOp op = new EcodigitalTransformOp(transform, EcodigitalTransformOp.TYPE_BILINEAR);
